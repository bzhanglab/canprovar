  ...
  if (ereg('ENSP', $otherid)){
     echo "<form action='infor.php' target='_blank' method='POST' enctype='MULTIPART/FORM-DATA' style='margin:0px; display:inline'>
         <input type='hidden' name='id' value='$otherid'>
          <input type='submit' value='$otherid' style='font-size:8pt; color:grey; border:none; border-bottom: 1px dotted green; backgound-color:white'></form>";
   }
 }
...
echo "<div id=main0  onclick=$click>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--&nbsp;<b><u>sequence</u></b>&nbsp;</div>";
...
echo "</font></td></tr></table>$r&nbsp;&nbsp;&nbsp;&nbsp;<font color='orangered' size=20>.</font>&nbsp;<font color=black>cancer related</font>&nbsp;&nbsp;&nbsp;&nbsp;<font color='0000FF' size=20>.</font>&nbsp;<font color=black>dbSNP</font>";
...
//     echo "<table align=center width=90%>";
   echo"<tr  align=center bgcolor='FFA500'>\n<td height=32>NO.</td><td>csID</td>";
    ...
    echo"<td>cancer sample</td>";
     ...
     echo "<td>resource<sup>+</sup></td>";

         $displaynew[]="dbsnp";
    echo "<td>validated dbSNP*</td>";
    echo "<td>Domain</td>";
    echo "</tr>";
...
$terms=split (', ', $entry);
  foreach($terms as $entrys){
   ...
   echo "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
     ...
     $page="http://www.ncbi.nlm.nih.gov/sites/entrez?db=pubmed&cmd=DetailsSearch&term=$pid[1][uid]&log$=activity";
 if(!is_null($terms[$pt])){
     echo "<a href=$page target='_blank'>$pid[1]</a>,&nbsp";
  }else{
    echo "<a href=$page>$pid[1]</a>";
  }
 }
echo "</td>";
