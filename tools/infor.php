...
if (ereg('.', $sampletype)){
       ...
       if (preg_match('/[a-z]/i', $sampletype1)){
        ...
        $query="select * from cancersnp  where sample like '%$sampletype1%' order by symbol";
	...
	echo "<tr><td><b>Searching results are listed below:</b><br><br></td></tr>";
       ...
       echo "<table width=75% align=center border=0.5>";
...
// muted inteactants
if (!is_null($genename)){
 echo "<br><tr><td><b>Interaction partner with cacer_related variations :</b>";
